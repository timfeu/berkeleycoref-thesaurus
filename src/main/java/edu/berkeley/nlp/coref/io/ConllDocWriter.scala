...
import edu.berkeley.nlp.coref.preprocess.{PreprocessingDriver, Reprocessor}
import edu.berkeley.nlp.coref.{Chunk, BaseDoc, OrderedClusteringBound}
...
object ConllDocWriter {
  ...
  def writeDoc(writer: PrintWriter, conllDoc: BaseDoc, clustering: OrderedClusteringBound) {
